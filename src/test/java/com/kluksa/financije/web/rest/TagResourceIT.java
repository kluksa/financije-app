...
import com.kluksa.financije.repository.TagRepository;
...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return tag;
    }
