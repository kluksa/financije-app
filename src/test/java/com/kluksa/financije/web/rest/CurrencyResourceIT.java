...
import com.kluksa.financije.repository.CurrencyRepository;
...
class CurrencyResourceIT {
    ...
    public static Currency createEntity(EntityManager em) {
        Currency currency = new Currency().code(DEFAULT_CODE).name(DEFAULT_NAME);
        return currency;
    }
    ...
    public static Currency createUpdatedEntity(EntityManager em) {
        Currency currency = new Currency().code(UPDATED_CODE).name(UPDATED_NAME);
        return currency;
    }
    ...
    void putNewCurrency() throws Exception {
        ...
        updatedCurrency.code(UPDATED_CODE).name(UPDATED_NAME);
    ...
    void fullUpdateCurrencyWithPatch() throws Exception {
        ...
        partialUpdatedCurrency.code(UPDATED_CODE).name(UPDATED_NAME);
