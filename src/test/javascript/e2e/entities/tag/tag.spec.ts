...
describe('Tag e2e test', () => {
  ...
  it('should load Tags', async () => {
    ...
    expect(await tagComponentsPage.getTitle()).to.eq('financijeApp.tag.home.title');
  ...
  it('should load create Tag page', async () => {
    ...
    expect(await tagUpdatePage.getPageTitle()).to.eq('financijeApp.tag.home.createOrEditLabel');
  ...
  it('should create and save Tags', async () => {
    ...
    await promise.all([tagUpdatePage.setNameInput('name'), tagUpdatePage.setDescriptionInput('description')]);
  ...
  it('should delete last Tag', async () => {
    ...
    expect(await tagDeleteDialog.getDialogTitle()).to.eq('financijeApp.tag.delete.question');
