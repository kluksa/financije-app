...
@RestController
@RequestMapping("/api/financije-kafka")
public class FinancijeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FinancijeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FinancijeKafkaResource(KafkaProperties kafkaProperties) {
